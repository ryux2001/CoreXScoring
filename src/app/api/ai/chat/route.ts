...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const effectiveBuildDraft = savedConversation?.state.buildDraft || body.buildDraft;
    const effectiveComboDraft = savedConversation?.state.comboDraft || body.comboDraft;
