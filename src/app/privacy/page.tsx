...
export default function PrivacyPage() {
  return (
    <LegalPage title="Política de privacidad">
      ...
      <p>Al crear una cuenta con Google, recibimos únicamente la información básica de perfil autorizada por Google: tu nombre, correo electrónico e identificador de cuenta. No solicitamos acceso a Gmail, Drive, contactos ni a otros contenidos de tu cuenta de Google.</p>
      ...
      <p className="text-sm text-zinc-500">Última actualización: 15 de septiembre de 2026.</p>
    </LegalPage>
  );
}
