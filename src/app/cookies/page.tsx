...
export default function CookiesPage() {
  return (
    <LegalPage title="Política de cookies">
      <p>Esta política explica cómo CoreXScoring usa cookies y tecnologías de almacenamiento local. Usamos tecnologías estrictamente necesarias para que el servicio funcione de forma segura y analítica agregada sin cookies publicitarias.</p>
