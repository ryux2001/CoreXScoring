...
export const Card = ({ id, slug, type, brand, name, price, currency, specs, compatibility, release_date, imageUrl }: ProductProps) => {
      ...
      <div className="flex flex-col p-5 pt-0">
        ...
        <div className="mt-6 flex items-baseline gap-1">
          <span className="text-2xl font-black text-white tracking-tighter">
            {currencySymbol}{Number(price).toLocaleString('es-ES')}
          </span>
        </div>
        ...
        <div className="mt-6 flex gap-2">
          ...
          <button className="flex-1 flex items-center justify-center gap-2 rounded-lg border border-zinc-800 py-3 text-xs font-bold text-zinc-400 transition-all hover:bg-zinc-900 hover:text-white cursor-pointer active:scale-95">
