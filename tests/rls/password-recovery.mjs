...
if (process.env.RUN_REMOTE_PASSWORD_RECOVERY_TESTS !== "1") {
  throw new Error("Define RUN_REMOTE_PASSWORD_RECOVERY_TESTS=1 para ejecutar la prueba remota de recovery.");
}
